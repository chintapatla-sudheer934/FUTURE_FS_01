      ...
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-brand">
            <span className="footer-logo">Sudheer</span>
            <p>
              Computer Science student passionate about building software solutions
            ...
            <div className="footer-socials">
              ...
              <a href="mailto:chintapatlasudheernaidu@gmail.com" className="footer-social" aria-label="Email">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li>
                <a href="mailto:chintapatlasudheernaidu@gmail.com">chintapatlasudheernaidu@gmail.com</a>
              </li>
              <li>
                <span>Thiruvallur, Tamil Nadu, India</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; 2024 <span>Sudheer</span>. All rights reserved.
          </p>
